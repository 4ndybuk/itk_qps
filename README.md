...
Multifunctional CLI tool to optimise ATLAS ITK Pixel assemlby workflow. Includes automation of database queries and fast batch uploads of test runs (e.g. from .csv files). Redcues manual effort to retrieve(push) component(s) information from(to) the production database. 
